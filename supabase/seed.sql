...
('7fadec6a-ccd5-4fb8-915b-6fc0d5c5d62d', 'Admin', 'admin@gelda.com', '$2b$10$zl3gugUjFEji1RXysQyMTOTDQyVBM2h0s2nGTTKtjWYmXSYzztvvG', (SELECT id FROM roles WHERE name = 'admin'));

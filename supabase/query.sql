...
create type public.app_activities as enum ('unknow', 'login', 'account_created', 'password_change','ticket_created', 'inboxes_preferences_change', 'profile_information_change', 'logout');
----------------------------------------------------------------------------------------------
...
create table public.activities (
  id            bigint generated by default as identity primary key,
  type          app_activities default 'unknow'::public.app_activities,
